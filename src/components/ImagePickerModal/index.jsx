    ...
    return (
        ...
        >
            <View style={styles.options}>
                ...
                >
                    <Icon space source={images.camera} color={colors.white} background={colors.dark_primary} rounded="half" size={64} />
                ...
                >
                    <Icon space source={images.gallery} color={colors.white} background={colors.dark_primary} rounded="half" size={64} />
